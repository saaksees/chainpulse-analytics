...
def _create_defaults():
    data = {
        "users": [
            {
                "id": "1",
                "username": "saakshi_theneostats",
                "password_hash": generate_password_hash("chainpulse123").decode('utf-8'),
                "role": "admin",
                "email": "saakshi.jaiswal@theneostats.com",
                "full_name": "Saakshi Jaiswal (TheNeoStats)",
            ...
            {
                "id": "2",
                "username": "saakshi_personal",
                "password_hash": generate_password_hash("chainpulse123").decode('utf-8'),
                "role": "admin",
                "email": "saakshijaiswal13@gmail.com",
                "full_name": "Saakshi Jaiswal (Personal)",
                "created_at": datetime.now().strftime("%Y-%m-%d"),
                "last_login": "Never",
                "uploads_count": 0
            },
            {
                "id": "3",
                "username": "saakshi_university",
                "password_hash": generate_password_hash("chainpulse123").decode('utf-8'),
                "role": "admin",
                "email": "saakshi.jaiswal@msam.christuniversity.in",
                "full_name": "Saakshi Jaiswal (Christ University)",
                "created_at": datetime.now().strftime("%Y-%m-%d"),
                "last_login": "Never",
                "uploads_count": 0
            }
